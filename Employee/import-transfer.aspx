...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="float: left;margin-left: -25px;display: inline-flex;width: 110%;background-color: #eee;height: 80px;margin-top: 33px;">
        ...
        <div class="container" style="margin-left: -253px;margin-top: 20px;">
            <button class="nutchamcong" style="background-color:#0077ff; border: none;padding-left: 20px;padding-right: 20px;"><a href="#" style="color:white;text-decoration:none;">UPLOAD FILE</a></button>
        </div>
    </div>
