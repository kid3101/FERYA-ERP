<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PublicReview.aspx.cs" Inherits="Attendance_PublicReview" %>
            ...
            <table class="table table-hover" style="width:100%; color:grey;margin-top: 20px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>14.186.73.139 -</td>
                        <td><a href="#" style="text-decoration:none;" title="Click here to update data">EDIT</a></td>
                    </tr>
                </tbody>
            </table>
