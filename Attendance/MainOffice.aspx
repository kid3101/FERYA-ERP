<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MainOffice.aspx.cs" Inherits="Attendance_MainOffice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <link href="../css/Attendance/MainOffice.css" rel="stylesheet" />
</asp:Content>
        ...
        <div class="row content" style="text-align:center;">
            ...
            <div class="col-sm-8">
                ...
                <div>
                    ...
                    <i class="fa fa-search" style="cursor: pointer;font-size: 33px;float: right;margin-top: -46px;margin-right: 20px;"></i>
                    <a href="MainOffice2.aspx" style="margin-left: -156px;"><button class="timkiem">Continue</button></a>
                </div>
            </div>
            <div class="col-sm-2 sidenav">
