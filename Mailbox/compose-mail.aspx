    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                    ...
                    <div class="box box-solid">
                        <div class="box-body no-padding">
                            <table class="table table-condensed">
                                <tbody>
                                    <tr>
                                        <td><a href="mail-box.aspx"><i class="fa fa-inbox"></i>Inbox<span class="label label-primary pull-right">12</span></a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="sent-mail.aspx" style="height: 40px; width: 365px"><i class="fa fa-envelope-o"></i>Sent</a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="important-mail.aspx"><i class="fa fa-file-text-o"></i>Important</a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="trash-mail.aspx"><i class="fa fa-trash-o"></i>Trash</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <!-- /.box-body -->
                ...
                <button type="reset" style="margin-left: 822px" class="btn btn-default"><i class="fa fa-times"></i>Discard</button>
