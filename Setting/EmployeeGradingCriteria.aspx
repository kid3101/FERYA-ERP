    ...
    <div class="container-fluid">
        ...
        <div class="container" style="margin-top: -82px;margin-left: 503px;">
            <div class="container" style="float:left;display: inline-flex;padding-left: 320px;margin-top: 20px;">
                <a href="AddNewEmployeeGradingCriteria.aspx" class="btn btn-info" data-toggle="tooltip" title="Create criteria for employee grading" style="color:white;margin-left: -78px;text-decoration:none;"><i class="fa fa-plus"></i>  CREATE CRITERIA FOR EMPLOYEE POINTS</a>
            </div>
