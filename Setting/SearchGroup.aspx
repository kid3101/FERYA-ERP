<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchGroup.aspx.cs" Inherits="Setting_SearchGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="margin-top: 20px;margin-left: 6px;">
        <span class="aa">
            ...
            <span class="closee">
                <a href="AddNewGroup2.aspx" class="closee"><i class="fa fa-times" title="Remove this condition"></i></a>
            </span>
        </span>
    </div>
