...
">
                <li class="active"><a href="#" style="cursor:pointer;height: 44px;text-decoration:none;">Update</a></li>
            </ul>
            <br>
        </div>
    </div>
        ...
        <div style="background-color:#eee;width:100%;height:80px;margin-top: -3px;display:flex;">
            ...
            <div class="col-sm-4" style="text-align:center;">
                <div style="margin-top:25px;">
                    <button class="nutchamcong" style="width: 30%;border: none;margin-left: -391px;"><a href="#" style="color:white;text-decoration:none;"> SAVE</a></button>
                </div>
            </div>
